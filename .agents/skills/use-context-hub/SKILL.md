...
4. Load only:
   ...
   - [`org/catalogue.md`](../../../org/catalogue.md) if you need a repo list.
5. Answer or plan using that vocabulary. Do not read sibling domains unless the
   task clearly crosses them.
6. If no domain fits, say so and either map via catalogue to the nearest domain
